...
| ---- | ------------------------------------------------------------ | --------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 1    | [![YouTube](https://img.youtube.com/vi/6pWxrbXzk8g/mqdefault.jpg)](https://www.youtube.com/watch?v=6pWxrbXzk8g) | ゲイン (＋プラグインの作りの基礎) | プラグインの実装 <br> `MATLAB_Gain.m` <br><br> 学習用のノート <br> `note_01_Gain.mlx`                                              | [PDF](https://kzkmtmt.github.io/audioPlugins/pdf/AudioPlugin_01_Gain.pdf) <br> [HTML](https://kzkmtmt.github.io/audioPlugins/AudioPlugin_01_Gain.html) |
