...
| ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | -------------------------------------- | ------------------------------------------------------------ |
| 1    | [![YouTube](https://img.youtube.com/vi/6pWxrbXzk8g/mqdefault.jpg)](https://www.youtube.com/watch?v=6pWxrbXzk8g&list=PLiM3LSbTyvwuP9VU9jQL1NJttGce5oZxS&index=1) | `MATLAB_Gain.m` <br> `note_01_Gain.mlx`                      | ゲイン (＋プラグインの作りの基礎) | [PDF](https://kzkmtmt.github.io/audioPlugins/pdf/AudioPlugin_01_Gain.pdf) <br> [HTML](https://kzkmtmt.github.io/audioPlugins/AudioPlugin_01_Gain.html) |
